...
- [the factory](https://github.com/hausfold/factory) — the night shift: docs-only PRs merge themselves under a lease you grant. Its README is the manual and the policy is machine-local (`factory config print`); the levers it reaches for here are `haus`'s `docs/night-shift.md`
