...
/// What a provider can actually do, advertised up front (trill's capability
/// pattern). Surfaces render only what the source can honor — no dead
...
struct ProviderCapabilities: Sendable, Equatable {
    ...
    /// Dismissing in flick can dismiss at the source too.
