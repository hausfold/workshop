# The published Flick.app release this flake installs.
#
# CI-OWNED once a release line exists: flick's release workflow (to be added
# with the first `bench release flick`) will rewrite these on every tag — the
