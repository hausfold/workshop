...
| `/download/<app>` | 302 to the latest notarized macOS release artifact (pounce, messages, perch; only perch shows it as a landing button — pounce's tarball still assumes Homebrew lays it out) | `worker.js` |
