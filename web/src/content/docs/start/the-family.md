...
| 🐦 [**trill**](https://github.com/nebelhaus/trill) | the messages — a native iMessage/SMS/RCS client reading `chat.db` read-only. **Archived, and opt-in in the rice** | you want to change the Messages client |
