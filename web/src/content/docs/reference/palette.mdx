...
[interactive preview](https://htmlpreview.github.io/?https://github.com/hausfold/nebelung/blob/main/preview/nebelung-latte.html).
...
[`haus.theme.accent`](/reference/options/#haustheme).
...
glow, lazygit, yazi, and the Zen browser render **all 14 accents** as separate
files; consumers pick one (the rice defaults to `mauve`). The other single-file
tools ship one theme with the default accent baked in.
</Aside>
...
[README](https://github.com/hausfold/nebelung) for the full workflow.
