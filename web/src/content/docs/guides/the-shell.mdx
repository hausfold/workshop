...
| `Super F` / `Super /` | **Find** — full-text search over the focused pane, live as you type (see [Finding things](#finding-things)) |
| `Super ⇧/` | The same overlay, across **every pane** in the session |
...
`⌘F` (or `⌘/`) opens a floating search overlay for the focused pane; `⌘⇧/`
opens the same overlay across every pane in the session. Results appear as you
type, with a preview of the lines around each hit.
