...
installed, whether your config repo has a `CLAUDE.md`, and whether the app you're
running from can write macOS's protected settings.
</Aside>
...
`~/.config/nix` is your own git repo — your machine in text. Dropping a
