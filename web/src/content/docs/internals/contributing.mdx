...
7. **release** — `./bench release <repo>`; CI does the rest, and the command
   ...
   (GitHub release + Homebrew formula bump), **trill** and **perch** (Homebrew
   cask bump + the rice's flake pin), and **nebelhaus** (the tag becomes what
...
it blocks. trill's and perch's runs commit `nix/release.nix` back to the repo,
