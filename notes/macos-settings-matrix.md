...
> **Scope.** This file is about what a rice can set *itself*, through `defaults`
> and nix-darwin. The settings that no amount of local writing can reach —
> TCC/permission grants, background-item allow-lists, notification style —
> sit behind a user-approved MDM enrollment and are covered separately in
